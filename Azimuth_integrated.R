...
dir.create("~/R/libraries", recursive = TRUE)
install.packages("cpp11", lib = "~/R/libraries")
library(cpp11, lib.loc = "~/R/libraries")
install.packages("igraph", lib = "~/R/libraries")
library(igraph, lib.loc = "~/R/libraries")
...
install.packages("cpp11", lib = "~/R/libraries", dependencies = TRUE)
install.packages("igraph", lib = "~/R/libraries", dependencies = TRUE)
devtools::install_github("satijalab/azimuth", "seurat5")
devtools::install_git(c("BSgenome.Hsapiens.UCSC.hg38’, ‘TFBSTools"))
